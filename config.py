...
available_setting = {
    ...
    "model": "gpt-3.5-turbo",  # 默认模型，还支持 gpt-3.5-turbo-16k, gpt-4, wenxin, xunfei等
    "model_list": ["gpt-3.5-turbo", "gpt-3.5-turbo-16k", "gpt-4", "wenxin", "wenxin-turbo", "wenxin-4", "xunfei","claude"], #默认支持的模型列表，需要逐个配置才能生效
